package com.codepath.modele.twitter;
...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_URL = "https://api.twitter.com/1.1";//"https://api.twitter.com/1.1";//
	public static final String REST_CONSUMER_KEY = "n9Elz2G05cSSlOTx90FYskVfA";//"FgoIJdfeJnVm77u4ncq11mCYG";//"";
	public static final String REST_CONSUMER_SECRET = "h0qJ8s3zSvcvtRTmoJp6qjmPW5m7K3Nk3YCBfq3iIjxws1kwlr";//"eu2MSE60EA6DLhL3UcfpVfYVTVWhluZTlfzsTiwWvTSkqDn4S7";//"";
