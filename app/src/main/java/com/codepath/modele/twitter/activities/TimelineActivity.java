...
public class TimelineActivity extends AppCompatActivity implements ComposeTweetFragment.StatusUpdateListener {
    ...
    private Tweet tweet;
//TweetDetailsActivity detail=new TweetDetailsActivity();
    //private RecyclerView lvTweet;
