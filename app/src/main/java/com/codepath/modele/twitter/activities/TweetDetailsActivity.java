package com.codepath.modele.twitter.activities;
...
import com.codepath.modele.twitter.R;
import com.codepath.modele.twitter.TwitterApplication;
import com.codepath.modele.twitter.TwitterClient;
import com.codepath.modele.twitter.constants.Extras;
import com.codepath.modele.twitter.fragments.ComposeTweetFragment;
import com.codepath.modele.twitter.models.Entities;
import com.codepath.modele.twitter.models.Media;
import com.codepath.modele.twitter.models.Tweet;
import com.codepath.modele.twitter.models.TwitterUser;
...
//    EditText mEditTextDetailsReplyToText=(EditText)findViewById(R.id.etDetails_ReplyToText);
   // RelativeLayout mRelativeLayoutSendAction=(RelativeLayout)findViewById(R.id.rlDetails_SendAction);
    @Override
    ...
    private void setupRetweetButton(final Tweet tweet) {
        ...
        if (tweet.isRetweeted()) {
            ivRetweet.setImageResource(R.drawable.retweet_action_done);
        } else {
            ivRetweet.setImageResource(R.drawable.retweet_action_default);
    ...
    public void setupFavoriteButton(final Tweet tweet) {
        ...
        if (tweet.isFavorited()) {
            ivFavorite.setImageResource(R.drawable.like_action_gone);
        } else {
            ivFavorite.setImageResource(R.drawable.like_action_default);
        }
    ...
    // information transferer vers l'activite details
