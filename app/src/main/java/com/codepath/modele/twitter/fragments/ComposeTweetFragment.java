package com.codepath.modele.twitter.fragments;
...
public class ComposeTweetFragment extends DialogFragment {
    ...
    private void dismissFragment(final View view){
        Button btndismiss=(Button)view.findViewById(R.id.btncancelTweet);
